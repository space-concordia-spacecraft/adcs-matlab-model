...
BEGIN Scenario
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            Name		 POSITION, VELOCITY in ITRF
            Type		 Report
            BaseDir		 User
            Style		 POSITION, VELOCITY in ITRF
            AGIViewer		 Yes
            Instance		 Satellite/Satellite1_Bias
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
                    SectionType		 2
...
"16 Dec 2019 20:18:22.696000000" "17 Dec 2019 01:18:22.696000000"
                        END Intervals
            ...
            BEGIN PreDataList
                BEGIN PreData
                    ...
                    Data		 Satellite/Satellite1 NorthEastDown.Axes
                END PreData
            END PreDataList
            DisplayOnLoad		 No
            FrameType		 0
            ...
            WindowRectLeft		 910
            WindowRectTop		 105
            WindowRectRight		 1592
            WindowRectBottom		 404
        END Report

        BEGIN Report
            Name		 POSITION, VELOCITY in ITRF1
            Type		 Report
            BaseDir		 User
            Style		 POSITION, VELOCITY in ITRF
            AGIViewer		 Yes
...
"16 Dec 2019 20:18:22.696000000" "18 Dec 2019 20:18:22.696000000"
                        END Intervals
        ...
        BEGIN Report
            ...
            Style		 Angledif
            AGIViewer		 Yes
            Instance		 Satellite/Satellite1_Bias/Sensor/Sensor1
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
                    SectionType		 2
...
"16 Dec 2019 18:39:11.348000000" "17 Dec 2019 18:39:11.348000000"
                        END Intervals
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 166848.652
            LaunchWindowStop		 -1042751.348
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 18 Dec 2019 17:00:00.000000000
                    Stop		 19 Dec 2019 17:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                EndTime		 31 Dec 2019 18:39:11.348000000
                CurrentTime		 17 Dec 2019 01:52:17.442297648
                Mode		 XRealtime
                Direction		 Forward
                UpdateDelta		 1
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 -26.27518336548813
                        CenterLongitude		 -44.66584108303942
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 -26.27518336548813
                                CenterLon		 -44.66584108303942
                                ZoomWidth		 93.77417320585016
                                ZoomHeight		 77.48409780000006
                            END ZoomLocation
                        END ZoomLocations
                ...
                BEGIN MapStyles
                    ...
                    BEGIN Style
                        ...
                        BEGIN RecordMovie
                            OutputFormat		 WMV
                            SdfSelected		 No
                            Directory		 C:\Users\Charles\Documents\STK 11 (x64)\Scenario2
                            BaseName		 Frame
                            Digits		 4
                            Frame		 0
                            LastAnimTime		 0
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance AreaTarget/Argentina
            AreaTarget/Argentina		
        END Instance
        Instance AreaTarget/Namibia
            AreaTarget/Namibia		
        END Instance
        Instance Satellite/Satellite1_Bias
            *		
            Satellite/Satellite1_Bias		
            Satellite/Satellite1_Bias/Sensor/Sensor1		
        END Instance
        Instance Satellite/Satellite1_Bias/Sensor/Sensor1
            Satellite/Satellite1_Bias/Sensor/Sensor1		
        END Instance
        Instance Satellite/Satellite2_Perfect
            Satellite/Satellite2_Perfect		
            Satellite/Satellite2_Perfect/Sensor/Sensor2		
        END Instance
        Instance Satellite/Satellite2_Perfect/Sensor/Sensor2
            Satellite/Satellite2_Perfect/Sensor/Sensor2		
        END Instance
        Instance Satellite/Satellite_Else
            Satellite/Satellite_Else		
            Satellite/Satellite_Else/Sensor/Sensor3		
        END Instance
        Instance Satellite/Satellite_Else/Sensor/Sensor3
            Satellite/Satellite_Else/Sensor/Sensor3		
        END Instance
